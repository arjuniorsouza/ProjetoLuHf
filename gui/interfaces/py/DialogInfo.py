...
################################################################################
## Form generated from reading UI file 'DialogInfoLyKQnt.ui'
##
...
"}")
    ...
    def retranslateUi(self, DialogInfo):
        ...
        self.label.setText(QCoreApplication.translate("DialogInfo", u"LuHf", None))
        self.btn_Close.setText("")
        self.label_2.setText(QCoreApplication.translate("DialogInfo", u"Info!", None))
        self.label_message.setText(QCoreApplication.translate("DialogInfo", u"<html><head/><body><p align=\"justify\"><br/></p></body></html>", None))
