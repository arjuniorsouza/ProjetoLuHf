...
################################################################################
## Form generated from reading UI file 'DialogErrorzHLAsv.ui'
##
...
"background-image: url(:/images/images/erro40.png);\n"
"background-position: center;")
...
"}")
        ...
        QMetaObject.connectSlotsByName(DialogErro)
    # setupUi

    def retranslateUi(self, DialogErro):
        DialogErro.setWindowTitle(QCoreApplication.translate("DialogErro", u"Dialog", None))
        self.label.setText(QCoreApplication.translate("DialogErro", u"LuHf", None))
        self.btn_Close.setText("")
        self.label_2.setText(QCoreApplication.translate("DialogErro", u"Error!", None))
        self.label_message.setText(QCoreApplication.translate("DialogErro", u"<html><head/><body><p align=\"justify\"><br/></p></body></html>", None))
